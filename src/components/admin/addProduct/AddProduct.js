      ...
      <div className={styles.product}>
        ...
        <Card cardClass={styles.card}>
          <form onSubmit={detectForm(id, addProduct, editProduct)}>
            ...
            <Card cardClass={styles.group}>
              {uploadProgress === 0 ? null : (
                <div className={styles.progress}>
                  <div className={styles['progress-bar']} style={{ width: `${uploadProgress}%` }}>{uploadProgress < 100 ? `Uploading ${uploadProgress}` : `Upload Complete ${uploadProgress}%`}</div>
                </div>
              )}


              <input type='file' accept='image/*' placeholder='product'
            ...
            <input type='number' placeholder='Product price' name='price' required value={product.price}
              onChange={(e) => handleInputChange(e)} />
            ...
            <input type='text' placeholder='Product brand' name='brand' required value={product.brand}
              onChange={(e) => handleInputChange(e)} />
